...
export default function Usdc() {
  ...
  return (
    <div>
      <h3>USDC on Ethereum Mainnet (network is fixed on this page)</h3>
      <div
        style={{
          color: data.usdcBalance === undefined ? "red" : "black",
          paddingBottom: "1em",
        }}
      >
        User balance:{" "}
        {data.usdcBalance
          ...
          : "Only for connected wallets"}
      </div>
      <div>
        <div>Last transfers:</div>
        <table>
          <thead>
            <tr>
              <th>From</th>
          ...
          <tbody>
            {data.lastTransfers.map((transfer, i) => (
              <tr key={i}>
